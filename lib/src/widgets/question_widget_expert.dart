...
class QuestionWidgetExpert extends StatefulWidget {
  const QuestionWidgetExpert({this.bloc, this.question,});

  // final Question question;
  final QuestionExpert question;
  final TriviaBloc bloc;

  @override
  _QuestionWidgetExpertState createState() => _QuestionWidgetExpertState();
}

class _QuestionWidgetExpertState extends State<QuestionWidgetExpert> {
  @override
