...
class TriviaPageExpert extends StatefulWidget {
  @override
  _TriviaPageExpertState createState() => _TriviaPageExpertState();
}

String coin;

class _TriviaPageExpertState extends State<TriviaPageExpert> {
  @override
