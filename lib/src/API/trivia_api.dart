...
class TriviaAPI implements QuestionsAPI {
  ...
  Future<bool> getQuestions(
    ...
    final url = 'http://xman.rorbible.plus/api/api/questions/1,2,3,4,5,6,7';
    // 'https://opentdb.com/api.php?amount=10&difficulty=$qdifficulty&type=$qtype&category=21';
